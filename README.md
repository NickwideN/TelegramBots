...
Cloud Run: `BOT_MODE=webhook`, `DB_BACKEND=postgres`, `WEBHOOK_URL`, `WISH_BOT_TOKEN`, **Connections** → Cloud SQL, `DATABASE_URL` (`postgresql://…@/DB?host=/cloudsql/PROJECT:REGION:INSTANCE`), у service account — **Cloud SQL Client**.
